...
void destruct_User_error(User_error *const error_ptr)
{
    ...
    assert(error_ptr and error_ptr->data);
...
/*!
 *Converts null-terminated string to one of Cnt_roots states. If Cnt_roots doesn't contain state with this name the behaviour is undefined
    ...
    if (roots1_ptr->cnt_roots == roots2_ptr->cnt_roots)
    {
        switch (roots1_ptr->cnt_roots)
        {
            ...
            case SQUARE_ONE_ROOT:
                ...
                return is_nil(roots1_ptr->root1 - roots2_ptr->root1);
            ...
            case SQUARE_TWO_ROOTS:
                ...
                return (is_nil(roots1_ptr->root1 - roots2_ptr->root1) and
                        is_nil(roots1_ptr->root2 - roots2_ptr->root2)) or
                       (is_nil(roots1_ptr->root1 - roots2_ptr->root2) and
                        is_nil(roots1_ptr->root2 - roots2_ptr->root1));
